-- tagai-data-supply tds_* 表（前缀 tds_，复用 tiptag 库）
-- 沿用 tiptag 手工应用迁移约定：直接对线上库执行此文件。
-- spec §5.2

-- 节点
CREATE TABLE IF NOT EXISTS `tds_node` (
...
-- 主题
CREATE TABLE IF NOT EXISTS `tds_topic` (
...
CREATE TABLE IF NOT EXISTS `tds_subtask` (
...
-- 任务派发
CREATE TABLE IF NOT EXISTS `tds_assignment` (
...
CREATE TABLE IF NOT EXISTS `tds_tweet_raw` (
...
-- 节点指标
CREATE TABLE IF NOT EXISTS `tds_node_metric` (
  `node_id` varchar(64) NOT NULL,
  `date` date NOT NULL,
...
-- cookie 健康日志
CREATE TABLE IF NOT EXISTS `tds_cookie_health_log` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `node_id` varchar(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tds_invite` (
